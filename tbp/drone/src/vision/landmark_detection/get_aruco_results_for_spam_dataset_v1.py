...
from aruco_detection import ArucoDetector, MARKER_WORLD_POSITIONS, MARKER_WORLD_ORIENTATIONS
    ...
    for img_path in png_files:
        ...
        if ids is not None and len(ids) > 0:
            ...
            for i, corner in enumerate(corners):
                ...
                camera_pos, camera_rot = detector.get_camera_pose(corner, marker_world_pos, marker_world_orient)
