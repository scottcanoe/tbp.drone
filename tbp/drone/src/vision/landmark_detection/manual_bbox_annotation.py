    ...
    def draw_bbox(self, event, x, y, flags, param):
        if event == cv2.EVENT_LBUTTONDOWN:
            ...
            if self.drawing:
                ...
                cv2.rectangle(
                    self.temp_image, (self.ix, self.iy), (x, y), (0, 255, 0), 2
                )
            ...
            cv2.rectangle(
                self.current_image, (self.ix, self.iy), (x, y), (0, 255, 0), 2
            )
...
def process_dataset():
    ...
    for img_path in png_files:
        ...
        print(
            "Left click and drag to draw. Press 'r' to retry, 's' to save and continue, 'q' to quit"
        )
        ...
        while True:
            ...
            if "spam_can" in annotations:
                ...
                cv2.rectangle(
                    annotator.current_image, (x1, y1), (x2, y2), (0, 255, 0), 2
                )
                cv2.putText(
                    annotator.current_image,
                    "Spam Can",
                    (x1, y1 - 10),
        ...
        annotation_file = os.path.join(
            annotations_dir, f"{img_path.stem}_annotations.json"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--file", type=str, help="Path to specific image file to annotate"
    )
